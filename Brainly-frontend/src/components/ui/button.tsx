...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
    {
        variants: {
            variant: {
                default:
                    "bg-violet-600 text-white hover:bg-violet-500 shadow-lg shadow-violet-900/30 hover:shadow-violet-700/40",
                destructive:
                    "bg-red-900/60 text-red-200 hover:bg-red-800/60 border border-red-800/50",
                outline:
                    "border border-white/10 bg-white/5 hover:bg-white/10 text-white hover:border-violet-500/40",
                secondary:
                ...
                gradient:
                    "bg-gradient-to-r from-violet-600 to-purple-600 text-white hover:from-violet-500 hover:to-purple-500 shadow-lg shadow-violet-900/30",
            },
            size: {
